...
*/
  ...
  RF->Factory("Gaussian::Sig(InvMass, mean[135,80,160], SIMw[10,0,100] )");
//  RF->Factory("BifurGauss::Sig(InvMass,SIMm[135,80,160], SIMwL[10,0,20], SIMwR[10,0,20]  )");
  RF->LoadSpeciesPDF("Sig");
