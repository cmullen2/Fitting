//root  --hsfit ConfigureBins.C
{
  ...
  RF->SetOutDir("/w/work1/home/chris/LatestAnalysisRuns/Data/DataJul17/HaspectOutput/Fitting/All3Binned20FilesProtonW10Costh20PolPos");
  ///////////////////////////////Load Variables
  ...
  RF->LoadBinVars("PolStateD",1,0,1);
...
//  RF->LoadAuxVars("Phi[-180,180]");
  ...
  chain.Add("/w/work1/home/chris/LatestAnalysisRuns/Data/DataJul17/HaspectOutput/TestMulti/Dev19.0Files20PhysicsAll.root");
