...
cout << "help meeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee " << endl;
  ...
  RF->FitSavedBins(1,kFALSE);//argument gives number of parameter fits to perform //Crashes here?? Something to do with PolState in the RooFit HSANA code
